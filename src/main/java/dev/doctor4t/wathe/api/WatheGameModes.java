...
import dev.doctor4t.wathe.game.gamemode.SecretMurderGameMode;
...
public class WatheGameModes {
    ...
    public static final Identifier SECRET_MURDER_ID = Wathe.id("secret_murder");
    ...
    public static final GameMode SECRET_MURDER = registerGameMode(SECRET_MURDER_ID, new SecretMurderGameMode(SECRET_MURDER_ID));
