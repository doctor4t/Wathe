...
public class WatheComponents implements WorldComponentInitializer, EntityComponentInitializer, ScoreboardComponentInitializer {
    ...
    public void registerEntityComponentFactories(@NotNull EntityComponentFactoryRegistry registry) {
        ...
        registry.beginRegistration(PlayerEntity.class, PlayerVariablesComponent.KEY).respawnStrategy(RespawnCopyStrategy.NEVER_COPY).end(PlayerVariablesComponent::new);
    }
