...
public class BackgroundRendererMixin {
    ...
    private static Vec3d overrideFogColor(Vec3d pos, CubicSampler.RgbFetcher rgbFetcher, Operation<Vec3d> original, @Local(argsOnly = true) ClientWorld world) {
        if (TMMClient.isTrainMoving() && world.getTimeOfDay() == 18000) {
            return TMMClient.DUSK_BACKGROUND_COLOR;
        }
